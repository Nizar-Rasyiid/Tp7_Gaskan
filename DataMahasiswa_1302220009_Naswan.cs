...
namespace tp7_DataMhs
{
    ...
    public class DataMahasiswa1302220031_Hasan
    {
        public class Mahasiswa
        {
            [JsonPropertyName("nama")]
        ...
        public void ReadJSON()
        {
            try
            {
                string fileName = "TP7_1_1302220031.json";
    ...
    public class DataMahasiswa1302220009_Naswan
    {
        public class Mahasiswa
        {
            [JsonPropertyName("nama")]
        ...
        public void ReadJSON()
        {
            try
            {
                string fileName = "TP7_1_1302220009.json";
